...
function inserirRegistro($pdo, $nome, $email, $senha, $quarto) {
    $sql = "INSERT INTO clientes (nome, email, senha, quarto) VALUES (:nome, :email, :senha, :quarto)";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    if (inserirRegistro($pdo, $nome, $email, $senha, $quarto)) {
